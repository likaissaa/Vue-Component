...
Vue.component('uiselect',
	...
	template: '\
		<div v-on:click = "show=!show" >\
			<input    class="form-control" v-bind:value="val" :class="[uiselectclass,show?\'bdblue radiusnone\':\'\']" :style="uiselectstyle" v-model="pleasechoose">\
			<div v-show="show" class="box center" :class="[uiselectclass,show?\'bdblue radiusnone\':\'\']" style="max-height:200px;overflow-y:scroll">\
